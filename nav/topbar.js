  ...
  function draw() {
    ...
    function fillMine() {
      ...
      /* MY PROFILE OPENS THE ANSWERS, not the view of them. Jessie, 2026-09-20: "have my profile go
         to https://2gather.network/intro/?perm=1&step=welcome". Somebody pressing their own name
      ...
      mine += anchor('My profile', 'https://2gather.network/intro/?perm=1&step=joy', 'cwtb-item');
