...
(function () {
  ...
  function style() {
    var css =
      ...
      '.cwtb-bar{background:#1F699E;display:flex;align-items:center;gap:14px;padding:0 16px;height:58px;'+ 'box-shadow:0 2px 0 rgba(0,0,0,.10),0 6px 14px rgba(15,45,70,.18);position:relative;z-index:5;}' +
