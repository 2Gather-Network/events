...
(function () {
  ...
  function draw() {
    ...
    function fillMine() {
      ...
      mine += anchor('My profile', 'https://2gather.network/intro/?perm=1&step=welcome', 'cwtb-item');
