...
*/
/*  Version: V1.81 | Date: 2026-08-26 | LAST CHANGE: the breadcrumb turns to ink on the sheet.
...
(function () {
  ...
  function go() {
    ...
    if (mode() === 'sheet') {
      document.documentElement.classList.add('cwtb-sheet');
      // the breadcrumb was written white for a blue page, and the sheet is not blue
      var c = document.getElementById('gp-crumb-groups');
      if (c && c.parentElement) { c.parentElement.className += ' cwtb-inkcrumb'; }
    }
  }
